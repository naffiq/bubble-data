...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"node_modules/d3/d3.js":[function(require,module,exports) {
var define;
!function() {
  var d3 = {
    version: "3.5.17"
...
},{}],"src/js/color-difference.js":[function(require,module,exports) {
...
},{}],"src/js/bubble-engine.js":[function(require,module,exports) {
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var BubbleEngine = function BubbleEngine(options) {
  ...
  var bubble = d3.layout.pack().sort(null).size([diameter, height]).padding(0);
  ...
  node.append("text").attr("dy", "2.4em").style("text-anchor", "middle").style("font-weight", "300").style("font-size", buildPopulationFontSize).text(buildDensityText); // Returns a flattened hierarchy containing all leaf nodes under the root.
...
},{"d3":"node_modules/d3/d3.js","numeral":"node_modules/numeral/numeral.js","./color-difference":"src/js/color-difference.js"}],"node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/data/countries.json":[function(require,module,exports) {
module.exports = {
  "name": "Countries",
  "children": [{
    "name": "Burundi",
...
var BubbleEngine = require('./js/bubble-engine'); // require('./scss/fonts.scss');
...
},{"./js/bubble-engine":"src/js/bubble-engine.js","./scss/main.scss":"src/scss/main.scss","./data/countries.json":"src/data/countries.json"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
